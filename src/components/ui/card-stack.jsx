...
// import Link from "next/link"; // Changed to normal anchor tag for Vite/React usage
import { cn } from "@/lib/utils"; // Assuming utils is at src/lib/utils.js
...
export function CardStack({
    ...
    return (
        ...
        >
            {/* Stage */}
            <div
                className="relative w-full flex justify-center" // Centering fix
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        on
                                            ? "bg-primary" // customized color
                                            : "bg-white/30 hover:bg-white/50", // customized color
                                    )}
    ...
    return (
        <div className="relative h-full w-full bg-[#111]">
            ...
            <div className="relative z-10 flex h-full flex-col justify-end p-5 text-left">
                <div className="truncate text-xl font-bold font-orbitron text-white drop-shadow-md">
                    {item.title}
                </div>
                {item.description ? (
                    <div className="mt-1 line-clamp-2 text-sm text-gray-300 font-sans">
                        {item.description}
                    </div>
                ) : null}
            </div>
